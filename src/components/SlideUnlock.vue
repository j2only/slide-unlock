...
<style lang="scss">
    ...
    .slideunlock {
        ...
        .slideunlock-handler {
            ...
            background: var(--su-color-handler-bg) var(--su-handler-bg) no-repeat center;
            cursor: grab;
            &:active {
